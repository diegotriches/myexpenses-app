...
export function CardCategoriasReceita({ transacoes }: Props) {
  ...
  return (
    <Card>
      ...
      <CardContent>
        {categorias.length === 0 ? (
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-4">Nenhuma receita encontrada</p>
        ) : (
          <div className="space-y-2.5">
            {categorias.slice(0, 5).map((c, index) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-center w-7 h-7 rounded-full bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs font-bold flex-shrink-0">
                    {index + 1}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm font-bold text-green-600 dark:text-green-400 ml-2 whitespace-nowrap">
                        R$ {c.total.toFixed(2)}
                      </span>
                    </div>
            ...
            <div className="pt-2 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center">
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Total em receitas:</span>
